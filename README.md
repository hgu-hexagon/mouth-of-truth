...
- first-run Leap Motion instruction sequence
...
- second temple approach toward the Mouth of Truth
- hand-in-mouth detection and hand insertion animation
- microphone answer capture with webcam face-frame capture
- answer collection visuals using eye-beam feedback
